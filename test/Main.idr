...
main = do
  ...
  timeZonePassed <- Test.TimeZone.run
  ...
  patternScalarPassed <- Test.PatternScalar.run
  ...
  patternZonedDateTimePassed <- Test.PatternZonedDateTime.run
  ...
  finalizeResults
    ...
    , ("time-zone provider tests", timeZonePassed)
    ...
    , ("scalar pattern tests", patternScalarPassed)
    ...
    , ("zoned date-time pattern tests", patternZonedDateTimePassed)
