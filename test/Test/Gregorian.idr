...
civilRoundTrips current final =
    if current > final
        then True
            ...
            case IotaTime.Calendar.Gregorian.refineDays current of
                Left _ => False
                Right date =>
...
gregorianCases =
    [ MkRuntimeCase "Gregorian epoch decodes to March 1 2000"
            (ymd (IotaTime.Calendar.Gregorian.fromDays 0) == (2000, March, 1))
    , MkRuntimeCase "Gregorian date show uses its public constructor"
                (show (IotaTime.Calendar.Gregorian.calendarDate 1 March 2000) ==
    ...
    , MkRuntimeCase "Gregorian changeover is the first valid date"
        ...
        , MkRuntimeCase "dynamic date before Gregorian changeover is rejected"
            (isLeft (IotaTime.Calendar.Gregorian.refineDate 14 October 1582))
        , MkRuntimeCase "dynamic raw day before changeover is rejected"
            (isLeft (IotaTime.Calendar.Gregorian.refineDays (-152445)))
        , MkRuntimeCase "dynamic raw conversion accepts the Gregorian changeover"
            (hasYmd (1582, October, 15) (refinedYmd (IotaTime.Calendar.Gregorian.refineDays (-152444))))
        , MkRuntimeCase "dynamic invalid day of month is rejected"
            (isLeft (IotaTime.Calendar.Gregorian.refineDate 30 February 2000))
        ...
        , MkRuntimeCase "2000 is a leap year"
            (ymd (IotaTime.Calendar.Gregorian.calendarDate 29 February 2000) == (2000, February, 29))
        , MkRuntimeCase "dynamic 2100 leap day is rejected"
            (isLeft (IotaTime.Calendar.Gregorian.refineDate 29 February 2100))
        , MkRuntimeCase "2400 is a leap year"
            (ymd (IotaTime.Calendar.Gregorian.calendarDate 29 February 2400) == (2400, February, 29))
        , MkRuntimeCase "day period rolls into the next year"
            (ymd (applyPeriod (days 1) (IotaTime.Calendar.Gregorian.calendarDate 31 December 2000)) ==
                (2001, January, 1))
        , MkRuntimeCase "day period crosses a non-leap century"
            (ymd (applyPeriod (days 1) (IotaTime.Calendar.Gregorian.calendarDate 28 February 2100)) ==
                (2100, March, 1))
        , MkRuntimeCase "day period crosses the 400-year leap day"
            (ymd (applyPeriod (days 1) (IotaTime.Calendar.Gregorian.calendarDate 29 February 2400)) ==
                (2400, March, 1))
        , MkRuntimeCase "multi-day period rolls into the following month"
            (ymd (applyPeriod (days 39) (IotaTime.Calendar.Gregorian.calendarDate 1 March 2000)) ==
                (2000, April, 9))
        , MkRuntimeCase "negative day period moves backward"
            (ymd (applyPeriod (days (-10)) (IotaTime.Calendar.Gregorian.calendarDate 25 March 2000)) ==
                (2000, March, 15))
        , MkRuntimeCase "day period clamps at Gregorian changeover"
            (applyPeriod (days (-1)) (IotaTime.Calendar.Gregorian.calendarDate 15 October 1582) ==
                IotaTime.Calendar.Gregorian.calendarDate 15 October 1582)
        , MkRuntimeCase "month period preserves a valid end-of-month day"
            (ymd (applyPeriod (months 2) (IotaTime.Calendar.Gregorian.calendarDate 31 January 2000)) ==
                (2000, March, 31))
        , MkRuntimeCase "month period clamps an invalid end-of-month day"
            (ymd (applyPeriod (months 1) (IotaTime.Calendar.Gregorian.calendarDate 31 January 2000)) ==
                (2000, February, 29))
        , MkRuntimeCase "month period crosses a year boundary"
            (ymd (applyPeriod (months 1) (IotaTime.Calendar.Gregorian.calendarDate 15 December 2000)) ==
                (2001, January, 15))
        , MkRuntimeCase "combined month periods aggregate before application"
            (ymd (applyPeriod (months 1 <+> months 1) (IotaTime.Calendar.Gregorian.calendarDate 31 January 2000)) ==
                (2000, March, 31))
        , MkRuntimeCase "month period clamps at Gregorian changeover"
            (ymd (applyPeriod (months (-1)) (IotaTime.Calendar.Gregorian.calendarDate 14 November 1582)) ==
                (1582, October, 15))
        , MkRuntimeCase "year period clamps leap day"
            (ymd (applyPeriod (years 1) (IotaTime.Calendar.Gregorian.calendarDate 29 February 2000)) ==
                (2001, February, 28))
        , MkRuntimeCase "year period clamps at Gregorian changeover"
            (ymd (applyPeriod (years (-1)) (IotaTime.Calendar.Gregorian.calendarDate 14 October 1583)) ==
                (1582, October, 15))
        , MkRuntimeCase "date period fields apply from largest to smallest"
            (ymd (applyPeriod (years 1 <+> days 1) (IotaTime.Calendar.Gregorian.calendarDate 28 February 1999)) ==
                (2000, February, 29))
        , MkRuntimeCase "negating a date period reverses its direction"
            (ymd (applyPeriod (negatePeriod (weeks 2)) (IotaTime.Calendar.Gregorian.calendarDate 15 March 2000)) ==
                (2000, March, 1))
        , MkRuntimeCase "scaling a date period multiplies its components"
            (ymd (applyPeriod (scalePeriod 3 (weeks 1)) (IotaTime.Calendar.Gregorian.calendarDate 1 March 2000)) ==
                (2000, March, 22))
        , MkRuntimeCase "March 1 2000 is Wednesday"
            (weekday (IotaTime.Calendar.Gregorian.calendarDate 1 March 2000) == Wednesday)
        , MkRuntimeCase "Gregorian dates compare by flat day"
            (IotaTime.Calendar.Gregorian.calendarDate 29 February 2000 < IotaTime.Calendar.Gregorian.calendarDate 1 March 2000)
        ...
        , MkRuntimeCase "next Monday selects the following matching day"
            (ymd (next {calendar = Gregorian} 1 Monday (IotaTime.Calendar.Gregorian.calendarDate 31 January 2000)) ==
                (2000, February, 7))
        , MkRuntimeCase "next zero selects the previous matching day"
            (ymd (next {calendar = Gregorian} 0 Monday (IotaTime.Calendar.Gregorian.calendarDate 2 February 2000)) ==
                (2000, January, 31))
        , MkRuntimeCase "next negative one moves one match further backward"
            (ymd (next {calendar = Gregorian} (-1) Monday (IotaTime.Calendar.Gregorian.calendarDate 2 February 2000)) ==
                (2000, January, 24))
        , MkRuntimeCase "previous Monday selects the preceding matching day"
            (ymd (previous {calendar = Gregorian} 1 Monday (IotaTime.Calendar.Gregorian.calendarDate 31 January 2000)) ==
                (2000, January, 24))
        , MkRuntimeCase "previous clamps at the Gregorian changeover"
            (previous {calendar = Gregorian} 1 Thursday (IotaTime.Calendar.Gregorian.calendarDate 15 October 1582) ==
                IotaTime.Calendar.Gregorian.calendarDate 15 October 1582)
        , MkRuntimeCase "third Monday of January 2000"
                        (ymd (IotaTime.Calendar.Gregorian.fromNthDay
                            Third Monday January 2000) == (2000, January, 17))
        , MkRuntimeCase "last Monday includes a matching final day"
                        (ymd (IotaTime.Calendar.Gregorian.fromNthDay
                            Last Monday January 2000) == (2000, January, 31))
        , MkRuntimeCase "second-to-last Monday counts backward from month end"
                        (ymd (IotaTime.Calendar.Gregorian.fromNthDay
                            SecondToLast Monday January 2000) ==
                (2000, January, 24))
        , MkRuntimeCase "third-to-last Monday counts backward from month end"
                        (ymd (IotaTime.Calendar.Gregorian.fromNthDay
                            ThirdToLast Monday January 2000) ==
                (2000, January, 17))
        , MkRuntimeCase "fourth-to-last Monday counts backward from month end"
                        (ymd (IotaTime.Calendar.Gregorian.fromNthDay
                            FourthToLast Monday January 2000) ==
                (2000, January, 10))
        , MkRuntimeCase "last weekday includes a matching final day"
                        (ymd (IotaTime.Calendar.Gregorian.fromNthDay
                            Last Sunday December 2000) == (2000, December, 31))
        , MkRuntimeCase "dynamic fifth weekday is rejected when absent"
            (isLeft (IotaTime.Calendar.Gregorian.refineNthDay Fifth Monday February 2000))
        , MkRuntimeCase "Gregorian week one starts on Sunday"
                        (ymd (IotaTime.Calendar.Gregorian.fromWeekDate
                            1 Sunday 2000) == (1999, December, 26))
        , MkRuntimeCase "Gregorian week zero uses arithmetic week numbering"
                        (ymd (IotaTime.Calendar.Gregorian.fromWeekDate
                            0 Sunday 2000) == (1999, December, 19))
        , MkRuntimeCase "Gregorian week five starts on January 23"
                        (ymd (IotaTime.Calendar.Gregorian.fromWeekDate
                            5 Sunday 2000) == (2000, January, 23))
  ]
